...
const url = `https://newsapi.org/v2/everything?language=sv&q=penningtvätt OR spelmyndigheten NOT musikal&from=2018-09-04S&sortBy=publishedAt&apiKey=${key}`
const url2 = `https://newsapi.org/v2/everything?language=sv&q=bedrägeri OR fraud&from=2018-09-10S&sortBy=publishedAt&apiKey=${key}`
